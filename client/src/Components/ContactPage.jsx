      ...
      <div className="contact row align-items-md-stretch">
        ...
        <div className="col-md-6">
          <div className="h-100 p-5 bg-light border rounded-3">
            <h2>
              {eng ? "Contact me on socials!" : "Sazinies ar mani soctīklos!"}
            </h2>
            <a
              href="https://www.facebook.com/alisakuz/"
              className="socialButton"
            >
              <i className="fa-brands fa-facebook-messenger fa-4x"></i>
            </a>
            <a href="https://twitter.com/alisafitday" className="socialButton">
              <i className="fa-brands fa-twitter fa-4x"></i>
            </a>
            <a
              href="https://www.instagram.com/alisafitday/"
              className="socialButton"
            >
              <i className="fa-brands fa-square-instagram fa-4x"></i>
            </a>
            <a
              href="https://www.linkedin.com/in/alisa-lagzdi%C5%86a-bb1b3922a"
              className="socialButton"
            >
